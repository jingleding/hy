...
module.exports = generator.Base.extend({
    ...
    writing: {
        copyProject: function () {
            ...
            var projectType = this.params.projectType[0]
            if(projectType == '0') {
                this.fs.copyTpl(
                    this.templatePath('framework1'),
                    this.destinationPath()
                ) 
            } else {
                this.fs.copyTpl(
                    this.templatePath('framework2'),
                    this.destinationPath()
                ) 

                //写.babelrc文件
                this.fs.copyTpl(
                    this.templatePath('framework2/.babelrc'),
                    this.destinationPath('.babelrc')
                )

                //写.gitignore文件
                this.fs.copyTpl(
                    this.templatePath('framework2/.gitignore'),
    ...
    method1: function() {
        ...
        if(type === '1') {
            var packageFilePath = this.templatePath('framework2/package.json')
